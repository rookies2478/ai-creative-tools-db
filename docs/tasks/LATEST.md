...
- latest_commit: （push後に確定。直前commitはa5aba58 "Audit comparison and category affiliate links"）
- branch: master
- origin_sync: push後に確認予定
- working_tree: invideo-ai-affiliate-pilot commit・push完了予定、working tree clean見込み
