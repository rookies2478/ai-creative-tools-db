...
usagePolicy:
  ...
  commercialUseByPlan:
    free: "生成画像の権利はLeonardo.AIに帰属するとされており、商用利用は認められていない場合があります"
    paid: "有料プランかつPrivate設定時にユーザーが画像の知的財産権を保有し商用利用が可能とされています（公式FAQ・利用規約より）"
    enterprise: "要確認"
  commercialUseNote: "有料プランでも、使用するモデル・生成コンテンツ・第三者の権利によって追加条件が生じる場合があります。最新の公式利用規約をご確認ください。本記事は法的助言ではありません。"
  rightsStatus: "unknown"
  rightsNote: "無料プランでは生成画像の権利がLeonardo.AIに帰属する場合があります。有料プラン＋Private設定時はユーザーがIPを保有するとされていますが、最新の公式利用規約で確認が必要です。"
